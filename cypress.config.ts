...
export default defineConfig({
  ...
  env: {
    ...
    JIRA_API_TOKEN: "ATATT3xFfGF0ggpqIxZSEtOUyy-BhI6Y3b1_LEg0e1FbRM8aw-eLyPNfCk8T3-FwDu3JlvG9Fm4s9hD4bLXWRFZCgU71efZcHUk92Y-2px4spsfILCrbWpMXTNI675TZjoRWw74fkHUIQ1ydMv1kWwXwFjkxlmUW3NX-bLF611wtzYP3P9tWXvk=34E38AF1",
  }
});
